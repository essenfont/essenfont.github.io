...
export const routes: RouteRecordRaw[] = [
  ...
  { path: '/docs', name: 'docs', component: () => import('./pages/docs/DocsIndexPage.vue') },
  { path: '/docs/architecture', name: 'docs-architecture', component: () => import('./pages/docs/ArchitecturePage.vue') },
